...
const InfractionsManager = new (require("../InfractionsManager"))

module.exports = {
	Warn: async (client, guild, target, moderator, reason, reasonLog) => {
		const infId = await InfractionsManager.createInfraction(guild.id, "Warn", "true", reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
	...
	Mute: async (client, guild, target, moderator, reason, reasonLog, muteRole, until) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Mute", until, reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
	...
	UnmuteManual: async (client, guild, target, moderator, reason, reasonLog, muteRole) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Unmute", "true", reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
	...
	Unmute: async (client, guild, target, moderator, reason, reasonLog, muteRole) => {
		...
		await guild.member(target.id).roles.remove(muteRole);
		const infId = await InfractionsManager.createInfraction(guild.id, "Unmute", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	Kick: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Kick", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	Ban: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Ban", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	TempBan: async (client, guild, target, moderator, reason, reasonLog, until) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Temp-ban", until, reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	ForceBan: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Force-ban", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	SoftBan: async (client, guild, target, moderator, reason, reasonLog, days) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Softban", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	Unban: async (client, guild, target, moderator, reason, reasonLog) => {
		reason = await reason;
		await guild.members.unban(target.id, reason);
		const infId = await InfractionsManager.createInfraction(guild.id, "Unban", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	UnbanTemp: async (client, guild, target, moderator, reason, reasonLog) => {
		reason = await reason;
		await guild.members.unban(target.id, reason);
		const infId = await InfractionsManager.createInfraction(guild.id, "Auto-unban", "true", reasonLog, target.tag, target.id, moderator.tag, moderator.id);
	...
	Deafen: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Deafen", "true", reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
	...
	Undeafen: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Undeafen", "true", reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
	...
	Voicekick: async (client, guild, target, moderator, reason, reasonLog) => {
		...
		const infId = await InfractionsManager.createInfraction(guild.id, "Voice-kick", "true", reasonLog, target.user.tag, target.user.id, moderator.tag, moderator.id);
